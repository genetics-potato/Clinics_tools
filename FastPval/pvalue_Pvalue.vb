...
'     
	...
	Public Shared Sub Java_pvalue_Pvalue_computePvalue(env As JNIEnv, obj As jobject, rawFile As jstring, sampleFile As jstring, samplingNumber As jint, samplingCutoff As jint, _
...
'     
	...
	Public Shared Sub Java_pvalue_Pvalue_generateBackground(env As JNIEnv, obj As jobject, rawFile As jstring, samplingNumber As jint, samplingCutoff As jint, firstOutputFile As jstring, _
...
'     
	...
	Public Shared Sub Java_pvalue_Pvalue_computePvalueByBackground(env As JNIEnv, obj As jobject, firstOutputFile As jstring, secondOutputFile As jstring, sampleFile As jstring, outputFile As jstring, _
...
'     
	...
	Public Shared Sub Java_pvalue_Pvalue_computeExactPvalue(env As JNIEnv, obj As jobject, rawFile As jstring, sampleFile As jstring, outputFile As jstring)
		Dim timer1 As time_t = time(Nothing)
...
Module DefineConstants
    ...
    Public Const GSL_DBL_EPSILON As Double = 0.000000000000000222044604925031
    Public Const GAUSS_XUPPER As Double = 8.572
    Public Const GAUSS_XLOWER As Double = -37.519
    Public Const GAUSS_SCALE As Double = 16.0
End Module
