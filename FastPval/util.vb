...
Public Module GlobalMembersUtil
    ...
    Public Function compareint(a As System.IntPtr, b As System.IntPtr) As Integer
        Return (CInt(a) - CInt(b))
    End Function

    Public Function comparefloat(a As System.IntPtr, b As System.IntPtr) As Integer
    ...
    Public Function producerand(times As Integer, range As Integer) As Integer()
    ...
    Public Function readline(f As FILE) As String
        '
    ...
    Public Function wc(file As String) As Integer
    ...
    Public Function binary_search(ByRef a As Single, ByRef b As Single, n As Single) As Single
        Dim m As Single
    ...
    Public Function mean(data As Single(), stride As UInteger, size As UInteger) As Single
    ...
    Public Function variance(data As Single(), stride As UInteger, n As UInteger, mean As Single) As Single
