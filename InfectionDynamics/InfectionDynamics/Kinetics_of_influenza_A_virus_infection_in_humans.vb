...
Public Class Model : Inherits MonteCarlo.Model
    ...
    Public Overrides Function params() As NamedValue(Of INextRandomNumber)()
        Return {
            New NamedValue(Of INextRandomNumber)(NameOf(p), GetRandom(-10000, 10000)),
            New NamedValue(Of INextRandomNumber)(NameOf(c), GetRandom(-10000, 10000)),
            New NamedValue(Of INextRandomNumber)(NameOf(beta), GetRandom(-10000, 10000)),
            New NamedValue(Of INextRandomNumber)(NameOf(delta), GetRandom(-10000, 10000))
        }
    End Function

    Public Overrides Function yinit() As NamedValue(Of INextRandomNumber)()
        Return {
            New NamedValue(Of INextRandomNumber)(NameOf(V), GetRandom(0, 10000000000.0)),
            New NamedValue(Of INextRandomNumber)(NameOf(T), GetRandom(0, 10000000000.0)),
            New NamedValue(Of INextRandomNumber)(NameOf(I), GetRandom(0, 10000))
        }
    End Function
End Class